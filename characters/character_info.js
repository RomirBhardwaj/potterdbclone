...
const sec = document.querySelector("#characters-info");
...
(async function(){
 const url=main_url+"/v1/characters/"+secondary_url;
...
if (key=="alias_names")
  alias.innerText=value[Math.floor(Math.random() * value.length)];
