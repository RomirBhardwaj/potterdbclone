...
const sec = document.querySelector("#potions-info");
...
(async function(){
 const url=main_url+"/v1/potions/"+secondary_url;
...
const text=k.replace("_"," ")
  ...
  if(key=="ingredients"||key=="inventors"||key=="manufacturers"||key=="characteristics"){
